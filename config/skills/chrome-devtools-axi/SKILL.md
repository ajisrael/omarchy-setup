...
chrome-devtools-axi is installed globally and pinned to an exact version by omarchy-setup's home.nix - invoke it directly with `chrome-devtools-axi <command>`.
